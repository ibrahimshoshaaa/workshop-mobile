...
/// خدمة الإشعارات المحلية - تنبيهات التسليمات القريبة والمديونيات والمخزون.
/// كل دالة هنا محمية بـ try/catch عشان أي مشكلة في مكتبة الإشعارات نفسها
/// (زي تعارض مع R8/ProGuard وقت بناء نسخة release) متوقفش عمليات أساسية
/// زي حفظ الطلب أو تسجيل الدفعة - الإشعارات ميزة إضافية، مش لازم تكسر التطبيق
