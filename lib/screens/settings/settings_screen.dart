        ...
        children: [
          ...
          Card(
            child: Padding(
              ...
              child: Row(
                children: [
                  const ModernIconBadge(icon: Icons.visibility_off_rounded, color: AppColors.wood, size: 40),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('إخفاء الأرقام', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                        Text('يخفي المبالغ والمديونيات عن العين لحد ما تعرضها',
